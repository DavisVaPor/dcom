            ...
            <div class="text-white">
                <div class="mt-3">
                    ...
                    <div class="border-y-2 border-emerald-400 py-2">
                        <p class="font-bold text-base text-gray-200 text-center uppercase ">
                            {{ Auth::user()->apellido }}
                        </p>
                        <p class="font-bold text-sm text-gray-200 text-center ">{{ Auth::user()->name }}</p>
                        <p class="font-bold text-sm text-gray-400 text-center ">{{ Auth::user()->cargo }}</p>
                        <p class="font-bold text-xs text-gray-600 text-center ">({{ Auth::user()->rol->name }})</p>
                    </div>
                </div>
                <div>
                    <ul class="mt-6 leading-10">
                        <p class="ml-2 border-blue-500 border-b-2 mb-1 text-sm text-gray-50 opacity-80">
                            Operaciones
                        ...
                        <li class="relative px-1 ">
                            <a class="inline-flex items-center w-full text-sm font-semibold text-white transition-colors duration-150 cursor-pointer hover:text-blue-400"
                                ...
                                <span class="ml-2 text-xs">SUPERVISION</span>
                            </a>
                        </li>
                        <li class="relative px-1 ">
                            <a class="inline-flex items-center w-full text-sm font-semibold text-white transition-colors duration-150 cursor-pointer hover:text-blue-400"
                        ...
                        <p class="ml-2 border-blue-500 border-b-2 mb-1 text-sm text-gray-50 opacity-80">Otros
                        </p>
                        <li class="relative px-1 ">
                            <a class="inline-flex items-center w-full text-sm font-semibold text-white transition-colors duration-150 cursor-pointer hover:text-blue-400"
                                href="#">
                            ...
                            <form method="POST" action="{{ route('logout') }}">
                                ...
                                <button onclick="event.preventDefault(); this.closest('form').submit();"
                                    ...
                                    <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="sign-out-alt"
                                        class="w-6 h-6" role="img" xmlns="http://www.w3.org/2000/svg"
                                        viewBox="0 0 512 512">
                                        <path fill="currentColor"

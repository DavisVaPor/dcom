...
<x-dialog-modal wire:model="modalAdd">
    ...
    <x-slot name="content">
        <div class="flex justify-between items-center">
            ...
            <div class="block ml-4">
                ...
                <input class="rounded-xl text-sm" type="date" id="" wire:model='fechaActa' min="2018-01-01"
                    max="{{ $fechaActual }}">
    ...
    <x-slot name="footer">
        <x-secondary-button wire:click="$set('subModalAdd',false)" wire:loading.attr="disabled">
            {{ __('Cancel') }}
        </x-secondary-button>
